...
namespace TrakHound.Api.v2.Streams.Data
{
    ...
    /// </summary>
    public class ConnectionDefinitionData :ConnectionDefinition, IStreamData
    {
        /// <summary>
        ...
        public StreamDataType StreamDataType { get { return StreamDataType.CONNECTION_DEFINITION; } }
        ...
        public ConnectionDefinitionData()
        {
